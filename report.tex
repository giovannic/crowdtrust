...
Our primary goal was to develop a generic framework that could be utilised in a
crowdsourcing application. We feel we have succeeded in developing a framework
to this spec. A number of factors are attributed to this: one clear necessity
in this framework is the ability to upload and then view assorted types of tasks. Upload
is easy enough to implement for multiple file types, actually displaying them could be more tricky. Through clever
use of jsp, we are able to display numerous types of task on the web page. With
small modifications -- adding a new media type to the database and a small amount of jsp code --
we would be able to display any new media type. The use of SubTask class heirarchy also
enables our internal algorithm to process generic types of tasks/responses.
...
The website turned out fairly well in the end. We were able to implement an aesthetically pleasing
design whilst still providing all the functionality needed. Through the website development
process we were able to learn a huge amount about both website design and actually coding
a website. Our group feels confident that given another project we could develop a similar,
or even improved, website. The development process taught us alot about servlets, a
valuable resource to use in client-server systems. We also feel that the implementation of
these servlet classes were well thought out and the coherent structure we used aided us.

\end{enumerate}

We all feel that we have developed extremely well as both individuals and as a team over the course of the project, every member has pulled their weight and we would not have been able to achieve anything without the diverse range of skills our group offers. Throughout the project we have all picked up both hard and soft skills, we have all gained experiences in unfamiliar languages and professional practices which will be invaluable in the future. 
