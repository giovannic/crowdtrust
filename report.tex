...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=\linewidth]{images/crowdtrustinterfact.jpg}
...
their estimated ability according to the algorithm. Below are the results for a test comprising of 
