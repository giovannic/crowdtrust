...
public class TestAlgorithmMulti extends TestCase {
	...
	public void testAlgorithm(){
		...
		testQs.add("test q1");
		testQs.add("test q2");
		assertTrue(TaskDb.addTask(accountId,"MultiTestTask", "This is a test?", accuracy, MediaType.IMAGE, AnnotationType.MULTIVALUED, InputType.RADIO, 15, expiry, testQs, new LinkedList<String>(), new LinkedList<String>(), 0)>0);
